...
const services = [
  { icon: '🎯', title: 'Lead Generation', desc: 'Strategic funnels that convert visitors into qualified leads.', gradient: 'from-blue-600/25 via-blue-500/10 to-cyan-500/5' },
  ...
  { icon: '💎', title: 'Brand Identity', desc: 'Complete brand systems that position you as premium.', gradient: 'from-cyan-600/25 via-cyan-500/10 to-blue-500/5' },
  ...
  { icon: '🖥️', title: 'Landing Pages', desc: 'Conversion-focused pages that turn traffic into revenue.', gradient: 'from-violet-600/25 via-violet-500/10 to-blue-500/5' },
];
  ...
  return (
    <>
      <section className="relative pt-36 pb-16">
        <div className="w-[95vw] lg:w-[90vw] max-w-[2000px] mx-auto px-6 text-center">
          <AnimatedSection animation="scaleUp">
            <span className="text-xs font-semibold uppercase tracking-[0.25em] text-accent-blue mb-4 block">Services</span>
            <h1 className="text-4xl md:text-6xl font-bold font-[var(--font-heading)] text-white mb-4">
              What We <span className="gradient-text">Build</span>
            </h1>
            <p className="text-muted text-lg mb-2">Premium services for ambitious businesses</p>
            <p className="text-accent-blue text-sm font-medium">Services start from &#8377;5000 onwards</p>
          </AnimatedSection>
        </div>
      </section>
      ...
      <section className="py-24">
        <div className="w-[95vw] lg:w-[90vw] max-w-[2000px] mx-auto px-6 text-center">
          <AnimatedSection animation="scaleUp">
            <h2 className="text-3xl md:text-4xl font-bold font-[var(--font-heading)] text-white mb-6">
