  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="w-[95vw] lg:w-[90vw] max-w-[2000px] mx-auto px-6">
          <div className="flex flex-col items-center text-center">
            <AnimatedSection animation="scaleUp">
              <span className="section-label text-xs font-semibold uppercase tracking-[0.3em] text-accent-blue">Ready to Grow?</span>
              <h1 className="section-heading text-4xl sm:text-5xl md:text-7xl font-bold font-[var(--font-heading)] text-white leading-tight">
                Let&apos;s Build Your <span className="gradient-text">Legacy</span>
              </h1>
              <p className="section-subtext text-muted text-lg max-w-2xl mx-auto leading-relaxed">
        ...
        {/* Main Content Area */}
        <div className="section-content-grid w-[95vw] lg:w-[90vw] max-w-[2000px] mx-auto px-6">
          <div className="grid lg:grid-cols-12 gap-6 items-stretch">
              ...
              <AnimatedSection animation="fadeLeft" className="relative">
                <div className="card-3d rounded-3xl overflow-hidden shadow-2xl shadow-accent-blue/10 bg-black/40 border border-white/5">
                  <div className="relative aspect-[4/5] w-full">
                    <Image 
                      src="/images/contact-hero-v2.png" 
                      alt="Contact Visual" 
                      fill 
            ...
            <div className="lg:col-span-7 flex flex-col">
              <AnimatedSection delay={0.2} animation="fadeRight">
                <div className="relative group">
                  ...
                  <div className="glass p-6 md:p-14 relative z-10 border-white/5 bg-black/40">
                    <div>
                      <h3 className="section-heading text-2xl font-bold font-[var(--font-heading)] text-white">Project Inquiry</h3>
                      <p className="section-subtext text-muted text-sm">Fill out the form below and I&apos;ll get back to you shortly.</p>
                    </div>
              ...
              {/* Brand Footer Fill */}
              <AnimatedSection delay={0.4} animation="fadeUp" className="flex-1 mt-6">
                <motion.div 
                  className="relative overflow-hidden glass rounded-3xl p-8 border border-white/5 flex flex-col items-center justify-center text-center bg-black/20 h-full w-full min-h-[300px]"
                  whileHover={{ y: -5, boxShadow: '0 10px 30px -10px rgba(59,130,246,0.1)' }}
                  transition={{ duration: 0.4 }}
                >
                  {/* Space elements */}
                  <div className="absolute inset-0 pointer-events-none opacity-60">
                    <div className="absolute top-10 left-12 w-2 h-2 bg-white rounded-full animate-pulse" />
                    <div className="absolute bottom-16 right-20 w-3 h-3 bg-accent-blue rounded-full animate-pulse" style={{ animationDelay: '1s' }} />
                    <div className="absolute top-1/4 right-1/4 w-1.5 h-1.5 bg-white rounded-full animate-ping" />
                    <div className="absolute bottom-1/4 left-1/4 w-4 h-4 bg-accent-purple/30 rounded-full blur-[2px]" />
                    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-accent-blue/5 rounded-full blur-3xl" />
                  </div>
                  ...
                  <motion.div 
                    ...
                    className="w-28 h-28 md:w-40 md:h-40 rounded-full border border-white/10 flex items-center justify-center mb-8 relative z-10"
                  >
                    <div className="absolute inset-1 rounded-full border border-accent-blue/30 border-t-accent-cyan" style={{ animation: 'spin 4s linear infinite' }} />
                    <div className="absolute inset-2 rounded-full border border-accent-purple/20 border-b-accent-pink" style={{ animation: 'spin 6s linear infinite reverse' }} />
                    <span className="font-[var(--font-heading)] font-bold text-4xl md:text-5xl text-white">RD</span>
                  </motion.div>
                  ...
                  >
                    <h3 className="font-[var(--font-heading)] font-bold text-3xl md:text-5xl tracking-[0.2em] text-transparent bg-clip-text bg-gradient-to-r from-white via-white/90 to-white/60 uppercase leading-tight">
                      Rahul Designs
                    </h3>
                    <p className="text-xs md:text-sm text-accent-blue uppercase tracking-[0.5em] mt-4 font-semibold">
